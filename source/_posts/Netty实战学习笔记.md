...
https://www.bilibili.com/video/BV1py4y1E7oA?from=search&seid=6932147091812247696
...
![](https://pic.imgdb.cn/item/609a6777d1a9ae528f453448.jpg)
...
![](https://pic.imgdb.cn/item/609a67cfd1a9ae528f476fd1.jpg)
...
![](https://pic.imgdb.cn/item/609a6859d1a9ae528f4b13bd.jpg)

​	selector的作用就是配合一个线程来管理多个channel，获取这些channel上发生的事件。非阻塞模式，不会让线程吊死在一个Channel上。适合连接数特别多，但流量低的场景。

​	调用selector的select()会阻塞到channel发生了读写就绪事件。
...
* limit
 ...
 ![](https://pic.imgdb.cn/item/609a77f5d1a9ae528fc68b10.jpg)

写模式下，position 是写入位置，limit 等于容量，下图表示写入了 4 个字节后的状态

![](https://pic.imgdb.cn/item/609a7869d1a9ae528fca0395.jpg)

flip 动作发生后，position 切换为读取位置，limit 切换为读取限制

![](https://pic.imgdb.cn/item/609a7883d1a9ae528fcabe75.jpg)

clear 动作发生后，状态

![](https://pic.imgdb.cn/item/609a791bd1a9ae528fcf0c03.jpg)

compact 方法，是把未读完的部分向前压缩，然后切换至写模式

![](https://pic.imgdb.cn/item/609a793ad1a9ae528fcff12e.jpg)
...
```java
Bytebuffer buf = ByteBuffer.allocate(16); // 不能动态调整
```
...
// 2. CharSet
ByteBuffer buffer1= StandardCharsets.UTF_8.encode("你好"); // 自动切换到读模式
...
用如下方式写入，可以将多个 buffer 的数据填充至 channel
...
在 while 中调用 channel.write 是因为 write 方法并不能保证一次将 buffer 中的内容全部写入 channe
...
public class TestFileChannelTransferTo {
    public static void main(String[] args) {
        try (FileChannel from = new RandomAccessFile("datain.txt", "rw").getChannel();
             FileChannel to = new RandomAccessFile("dataout.txt", "rw").getChannel();) {
...
* 果目录已存在，会抛异常 FileAlreadyExistsException
...
![](https://pic.imgdb.cn/item/609b6c30d1a9ae528f4dad10.jpg)
...
* TLV 格式，即 Type 类型、Length 长度、Value 数据，类型和长度已知的情况下，就可以方便获取消息大小，分配合适的 buffer，缺点是 buffer 需要提前分配，如果内容过大，则影响 server 吞吐量
  ...
  * Http 2.0 是 LTV 格式
  ...
  ![](https://pic.imgdb.cn/item/609b6cb0d1a9ae528f51f4f1.jpg)
...
![](https://pic.imgdb.cn/item/609b7723d1a9ae528f9fa913.jpg)
...
![](https://pic.imgdb.cn/item/609b854cd1a9ae528f162ea5.jpg)

* 阻塞 IO

![](https://pic.imgdb.cn/item/609b856fd1a9ae528f171951.jpg)

* 非阻塞  IO

![](https://pic.imgdb.cn/item/609b85bed1a9ae528f191efd.jpg)

* 多路复用

![](https://pic.imgdb.cn/item/609b85dcd1a9ae528f19e847.jpg)

* 信号驱动
* 异步 IO

![](https://pic.imgdb.cn/item/609b85fed1a9ae528f1aba89.jpg)

* 阻塞 IO vs 多路复用

![](https://pic.imgdb.cn/item/609b8636d1a9ae528f1c1a75.jpg)
...
![](https://pic.imgdb.cn/item/609b8941d1a9ae528f2db85c.jpg)
...
![](https://pic.imgdb.cn/item/609b8994d1a9ae528f2f98af.jpg)
...
![](https://pic.imgdb.cn/item/609b89ebd1a9ae528f318044.jpg)
...
![](https://pic.imgdb.cn/item/609b8a33d1a9ae528f330cf9.jpg)
...
![](https://pic.imgdb.cn/item/609b8e3fd1a9ae528f4d1651.jpg)
...
new ServerBootstrap()
    // bootEventLoop, WorkerEventLoop(selector, thread)
    .group(new NioEventLoopGroup()) // 1
    // 选择服务器的ServerSocketChannel实现
    .channel(NioServerSocketChannel.class) // 2
    // 负责处理连接 worker(child)负责处理读写， 决定了worker(child)能执行哪些操作(handler)
    .childHandler(new ChannelInitializer<NioSocketChannel>() { // 3
        protected void initChannel(NioSocketChannel ch) {
            // channel 代表和客户端进行读写的通道 Initializer初始化，负责添加别的Handler
            // ByteBuf转换为字符串
...
![](https://pic.imgdb.cn/item/609b90f9d1a9ae528f5ee00a.jpg)
...
* 2 处，选择客户 Socket 实现类，NioSocketChannel 表示基于 NIO 的客户端实现，其它实现还有
  ...
  ![](F:/studyDoc/netty/讲义/img/0007.png)
...
![](https://pic.imgdb.cn/item/609b9778d1a9ae528f909179.jpg)
...
![](https://pic.imgdb.cn/item/609b9b9fd1a9ae528fabcce0.jpg)
...
![](https://pic.imgdb.cn/item/609b9becd1a9ae528fada66c.jpg)
...
![](https://pic.imgdb.cn/item/609b9c24d1a9ae528faee77d.jpg)
...
![](https://pic.imgdb.cn/item/609bad30d1a9ae528f1cfd2e.jpg)

经研究发现，看病可以细分为四个步骤，经拆分后每个步骤需要 5 分钟，如下

![](https://pic.imgdb.cn/item/609bad44d1a9ae528f1d9f31.jpg)

因此可以做如下优化，只有一开始，医生 2、3、4 分别要等待 5、10、15 分钟才能执行工作，但只要后续病人源源不断地来，他们就能够满负荷工作，并且处理病人的能力提高到了 `4 * 8 * 12` 效率几乎是原来的四倍

![](https://pic.imgdb.cn/item/609bad59d1a9ae528f1e5270.jpg)
...
![](https://pic.imgdb.cn/item/609bb521d1a9ae528f54f0b7.jpg)
...
![](https://pic.imgdb.cn/item/609bce0cd1a9ae528f15972b.jpg)
...
![](https://pic.imgdb.cn/item/609bce92d1a9ae528f1a9faf.jpg)

![](https://pic.imgdb.cn/item/609bd19dd1a9ae528f398997.jpg)
...
![](https://pic.imgdb.cn/item/609bd202d1a9ae528f3d6a8d.jpg)
...
![](https://pic.imgdb.cn/item/609bd238d1a9ae528f3f7082.jpg)
...
![](https://pic.imgdb.cn/item/609bd259d1a9ae528f4098ad.jpg)
        ...
        protected void initChannel(NioSocketChannel ch) {
            ch.pipeline().addLast(new ChannelInboundHandlerAdapter(){
                ...
                public void channelRead(ChannelHandlerContext ctx, Object msg) {
                    ...
                    // 思考：需要释放 buffer 吗 需要吧 重新分了数据
                    // 思考：需要释放 response 吗 不需要 后面用了
                }
            });
        }
    }).bind(8080);
...
>
> ![](https://pic.imgdb.cn/item/609f24cdd1a9ae528f5e5599.jpg)
>
> * 为了解决此问题，引入了窗口概念，窗口大小即决定了无需等待应答而可以继续发送的数据最大值
>
> ![](https://pic.imgdb.cn/item/609f24f9d1a9ae528f6020fd.jpg)
>
...
![](https://pic.imgdb.cn/item/609f2525d1a9ae528f61cd40.jpg)
...
![image-20210515095358344](C:\Users\81929\AppData\Roaming\Typora\typora-user-images\image-20210515095358344.png)
...
![](https://pic.imgdb.cn/item/609f54c16ae4f77d35da9498.jpg)
...
* SO_RCVBUF 既可用于 SocketChannal 参数，也可以用于 ServerSocketChannal 参数（建议设置到 ServerSocketChannel 上）
...
![](https://pic.imgdb.cn/item/609fca196ae4f77d352bda58.jpg)
...
![](https://pic.imgdb.cn/item/609fa61d6ae4f77d351b63cc.jpg)
...
![](https://pic.imgdb.cn/item/609fca606ae4f77d352e5205.jpg)
